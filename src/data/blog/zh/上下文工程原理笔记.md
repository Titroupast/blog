...
- **早期 Prompt Engineering**：关注特定排版格式（如 JSON 结构、Markdown 分割）或是各种奇妙的“提示词咒语”（如 _"Let's think step by step"_、_"给你小费"_、_"事关世界和平"_ 等）。然而随着现代大模型原生能力提升，这些表层咒语的收益已越来越低。
